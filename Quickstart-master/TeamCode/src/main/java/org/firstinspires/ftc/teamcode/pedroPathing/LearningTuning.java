...
public class LearningTuning extends SelectableOpMode {
    ...
    public LearningTuning(String name, Consumer<SelectScope<Supplier<OpMode>>> opModes) {
        super(name, opModes);
    }
...
class LearningLocalizationTest extends OpMode {
    @Override
    public void init() {}
...
class LearningForwardTuner extends OpMode {
 ...
 */
class LearningLateralTuner extends OpMode {
    public static double DISTANCE = 48;
 ...
 * @version 1.0, 5/6/2024
 */
class LearningTurnTuner extends OpMode {
 ...
 */
class LearningForwardVelocityTuner extends OpMode {
 ...
 * @version 1.0, 3/13/2024
 */
class LearningLateralVelocityTuner extends OpMode {
    private final ArrayList<Double> velocities = new ArrayList<>();
 ...
 * @version 1.0, 3/13/2024
 */
class LearningForwardZeroPowerAccelerationTuner extends OpMode {
 ...
 * @version 1.0, 3/13/2024
 */
class LearningLateralZeroPowerAccelerationTuner extends OpMode {
    private final ArrayList<Double> accelerations = new ArrayList<>();
    public static double VELOCITY = 30;
    private double previousVelocity;
    private long previousTimeNano;
 ...
 */
class LearningTranslationalTuner extends OpMode {
 ...
 * @version 1.0, 3/12/2024
 */
class LearningHeadingTuner extends OpMode {
    public static double DISTANCE = 40;
    private boolean forward = true;
 ...
 * @version 1.0, 3/12/2024
 */
class LearningDriveTuner extends OpMode {
    public static double DISTANCE = 40;
    private boolean forward = true;
 ...
 * @version 1.0, 3/12/2024
 */
class LearningLine extends OpMode {
    public static double DISTANCE = 40;
    private boolean forward = true;
 ...
 * @version 1.0, 3/13/2024
 */
class LearningCentripetalTuner extends OpMode {
 ...
 */
class LearningTriangle extends OpMode {
 ...
 * @version 1.0, 3/12/2024
 */
class LearningCircle extends OpMode {
